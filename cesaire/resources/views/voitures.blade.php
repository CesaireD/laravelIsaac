                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        @foreach ($lists as $list)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-primary" href="{{route('update', ['id' => $list->id]) }}"><i class="icon_plus_alt2"></i>&nbsp;Mettre a jour</a>
                                        {{-- <a class="btn btn-success" href="#"><i class="icon_check_alt2"></i></a> --}}
                                        <a class="btn btn-danger" href="{{route('delete', ['id'=> $list->id])}}"><i class="icon_close_alt2"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Supprimer</a>
                                    </div>
                                </td>
                            </tr>
